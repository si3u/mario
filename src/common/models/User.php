...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['email', 'avatar', 'address', 'cover'], 'string', 'max' => 255],

            ['role', 'default', 'value' => ROLE_MEMBER],
            ['role', 'in', 'range' => [
                ROLE_MEMBER,
                ROLE_EDITOR,
                ROLE_SALES,
            ...
            [['passwd'], 'string', 'min' => 5, 'on' => 'create'],
            [['passwd_confirm'], 'compare', 'compareAttribute' => 'passwd', 'message' => Yii::t('app', 'Passwords do not match'), 'on' => 'create'],
